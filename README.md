...
> [!NOTE]
> This is a **HODL1 fork** of [googleworkspace/cli](https://github.com/googleworkspace/cli).
> For fork-specific documentation (branch strategy, MCP Server, versioning), see [README.custom.md](README.custom.md).
